    ...
    <div className={style.projectsBlock}>
      <div className={`${styleContainer.container} ${style.projectsContainer}`}>
        ...
        <div className={style.projects}>
          <Project title={projets.project1.title} img={projets.project1.img} alt={projets.project1.alt} description={projets.project1.description} url={projets.project1.url} />
          <Project title={projets.project2.title} img={projets.project2.img} alt={projets.project2.alt} description={projets.project2.description} url={projets.project2.url} />
          <Project title={projets.project3.title} img={projets.project3.img} alt={projets.project3.alt} description={projets.project3.description} url={projets.project3.url} />
        </div>
      </div>
    </div>
